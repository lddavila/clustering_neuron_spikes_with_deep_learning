...
for i=1:size(blind_pass_table,1)
    ...
    print_message_using_dataqueue(size(still_mergable_data,1),"determine_which_blind_pass_neurons_overlap_parallel.m Created "+string(cluster_group_counter)+"groups so far")
