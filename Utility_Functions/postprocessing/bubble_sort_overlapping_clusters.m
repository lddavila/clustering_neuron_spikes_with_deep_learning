...
for counter=1:size(table_of_other_appearences,1)
    ...
    for current_wave_ind =1:size(table_of_other_appearences,1)-counter
        cluster_1_wave= table_of_other_appearences{current_wave_ind,"mean_waveform_rep_wire_1"}{1};
        cluster_2_wave = table_of_other_appearences{current_wave_ind+1,"mean_waveform_rep_wire_1"}{1};
