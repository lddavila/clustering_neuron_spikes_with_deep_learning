function [output, aligned, reg_timestamps,reg_timestamps_of_the_spikes,peak_pcs,cleaned_clusters] = run_spikesort_ntt_core_ver4(raw, timestamps, good_spikes_idx_inj, ir, tvals, filenames, config,channels,sorted_spike_windows,dir_to_save_spike_windows_to,current_tetrode)
