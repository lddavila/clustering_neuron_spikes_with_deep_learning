function [] = get_ratio_tables_for_every_unit_on_cluster()
home_dir = cd("..");
cd("..");
addpath(genpath(pwd));
...
for i=1:length(gt_data)
    ...
    ratio_table = get_average_amplitude_per_unit_on_each_channel(dir_with_channel_data,ground_truth_idxs,tol_amount,varargin);
