...
for i=1:size(blind_pass_table,1)
    ...
    for j=i+1:size(blind_pass_table,1)
        ...
        if index_of_larger==1
            ...
            number_of_timestamps_in_common = find_number_of_true_positives_given_a_time_delta(current_neuron_ts,compare_neuron_ts,config.TIME_DELTA);
        elseif index_of_larger==2
            ...
            number_of_timestamps_in_common = find_number_of_true_positives_given_a_time_delta(compare_neuron_ts,current_neuron_ts,config.TIME_DELTA);
        else
