...
what_is_pre_computed = ["z_score","mean_and_std","initial_pass"];
what_is_pre_computed = ["z_score","mean_and_std","initial_pass","dictionaries min_z_score 3 num_dps 60",...
    "dictionaries min_z_score 4 num_dps 60",...
    "dictionaries min_z_score 5 num_dps 60",...
    "dictionaries min_z_score 6 num_dps 60",...
    "dictionaries min_z_score 7 num_dps 60",...
    "dictionaries min_z_score 8 num_dps 60",...
    "dictionaries min_z_score 9 num_dps 60",...
    "spike_windows min_z_score 3 num dps 60",...
    "spike_windows min_z_score 4 num_dps 60",...
    "spike_windows min_z_score 5 num_dps 60",...
    "spike_windows min_z_score 6 num_dps 60",...
    "spike_windows min_z_score 7 num_dps 60",...
    "spike_windows min_z_score 8 num_dps 60",...
    "spike_windows min_z_score 9 num_dps 60",...
    "spikes_per_channel min_z_score 3",...
    "spikes_per_channel min_z_score 4",...
    "spikes_per_channel min_z_score 5",...
    "spikes_per_channel min_z_score 6",...
    "spikes_per_channel min_z_score 7",...
    "spikes_per_channel min_z_score 8",...
    "spikes_per_channel min_z_score 9"];
