function [] = create_3_and_2_channel_data_sets(which_recording,varargin)
...
number_of_channels_to_use = [2,3,4,5,6,7,8];
rng(0);
        ...
        try
            ...
            if ~isempty(varargin)
                if varargin{2} == "ic"
                    ...
                    config.BLIND_PASS_DIR_PRECOMPUTED = fullfile(config.BLIND_PASS_DIR_PRECOMPUTED,"subset_"+config.RECORDING_NAME+"_"+string(current_number_of_channels)+"_ch");
                else
