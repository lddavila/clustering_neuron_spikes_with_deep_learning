function [] = create_3_and_2_channel_data_sets_with_new_features(which_recording,varargin)
        ...
        try
            ...
            if ~isempty(varargin)
                if varargin{2} == "ic"
                    ...
                    config.BLIND_PASS_DIR_PRECOMPUTED = fullfile(config.BLIND_PASS_DIR_PRECOMPUTED,"new_features_subset_"+config.RECORDING_NAME+"_"+string(current_number_of_channels)+"_ch");
                else
