...
raw_channel_count = rec_ch_data_struct.("ironclust_raw_unit_numbers");
raw_noise_count = rec_ch_data_struct.("ironclust_raw_noise_numbers");

figure;
yyaxis left
plot(10:0.1:50,raw_channel_count(1:how_many_units_to_plot,:))
ylabel("Signal Count")

yyaxis right
plot(10:0.1:50,raw_noise_count(1:how_many_units_to_plot,:))
ylabel("Noise Count")
