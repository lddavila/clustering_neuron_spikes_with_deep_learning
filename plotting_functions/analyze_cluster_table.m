...
unit_counts_in_bp = groupcounts(blind_pass_table,"Max Overlap Unit");
missing_units = setdiff(unit_list,unit_counts_in_bp{:,"Max Overlap Unit"},'stable');
...
for i=1:size(sliced_bp_table,1)
    ...
    number_of_appearences(unit_id) = number_of_appearences(unit_id) + 1;
