function [] = run_examples_by_passed_param_new_spike_cutting(which_recording)
...
for k=1:length(number_of_channels_to_use)
    ...
    for i=beginning:the_end
        ...
        config.BLIND_PASS_DIR_PRECOMPUTED = fullfile(config.BLIND_PASS_DIR_PRECOMPUTED,config.RECORDING_NAME+"_"+string(current_number_of_channels)+"_channels+ic_cutting");
        disp("Recording Name");
