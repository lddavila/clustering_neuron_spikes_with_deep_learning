...
%                  Requirements
%                  1. The file must be a Neuralynx Tetrode data file.
%                       If writing to a new file, the correct extension is ".ntt"
%                  2. The filename must be a string and a row vector.
%                  Example:  
%                      Filename = 'C:\TestDirectory\TestFile.ntt'
%
