...
%                  Requirements
%                  1. The file must be a Neuralynx Timestamp data file.
%                       If writing to a new file, the correct extension is ".nts"
%                  2. The filename must be a string and a row vector.
%                  Example:  
%                      Filename = 'C:\TestDirectory\TestFile.nts'
%
...
%                  field only, then we would have one parameter.
...
% 
%         Function( Filename, AppendFile, ExtractMode, 1, NumRecs, FieldSelection, Timestamps );
%         
...
%         ModeArray(3) = 9;
% 
%         Function( Filename, AppendFile, ExtractMode, ModeArray, NumRecs, FieldSelection, Timestamps, Header );
%         
