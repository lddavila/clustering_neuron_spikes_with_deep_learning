...
%             SE1.nse') or relative ('SE1.nse') path of the file you wish
%             to import. 
...
%      [Timestamps,Samples] = Nlx2MatSpike('test.ntt',FieldSelectionFlags,0,1,[]);
%
%   OUTPUT VARIABLES:
...
%
%
%   EXAMPLE: [Timestamps, ScNumbers, CellNumbers, Features, Samples, Header] =
%            Nlx2MatSpike('test.nst', [1 1 1 1 1], 1, 1, [] );
%   Uses extraction mode 1 to return all of the data from all of the records
%   in the file test.nst.
%
%   EXAMPLE: [Timestamps, Samples, Header] = Nlx2MatSpike('test.ntt',
%            [1 0 0 0 1], 1, 2, [14 30]);
