...
config.percentiles_to_use = 99:-1:1;
...
config.FP_TO_TABLE_OF_ALL_BP_CLUSTERS= fullfile(config.base_file_path,"Data","50_neuron_bp_table_with_hists_and_mean_waveforms.mat");
...
%
config.WHICH_NEURAL_NET = "num_und_unts";
...
config.DIR_TO_SAVE_RESULTS_TO = "08_06_2025_acc_cat_3_and_4";
...
config.FP_TO_COMPLEX_MERGE_OR_DONT_NN = fullfile(config.base_file_path,"Neural_Networks","complex_merge_or_dont_nn","accuracy score 0.99367 num layers 1 num neurons per layer15 complex merge checker.mat");
...
config.FP_TO_SIMPLE_GROUP_OR_DONT_NN = fullfile(config.base_file_path,"Neural_Networks","simplest_group_or_dont_without_filter","simplest_group_or_dont.mat");
...
config.FP_TO_MULTICHANNEL_TABLES = [fullfile(config.base_file_path,"Data","hierarchy_training_table.mat"),
    fullfile(config.base_file_path,"Data","blind_pass_table_4_ch.mat")];
