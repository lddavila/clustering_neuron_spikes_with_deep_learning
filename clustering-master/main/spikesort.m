...
function [the_aligned, the_cleaned_clusters, the_grades] = spikesort(the_raw, the_timestamps, the_ir, the_tvals, the_config)
...
%   is the number of grades.
    ...
    the_aligned = align_to_peak(r_raw, r_tvals, r_ir);
    ...
    clusters = iterative_clustering(the_aligned, r_ir, r_tvals, ...
