...
for gradience_level = possible_gradience_levels
    for threshold_level = possible_threshold_levels
        col_1_gr_and_thr = add_various_cols_of_over_percentage_above_n(blind_pass_table(remaining_idxs(:,1),"overlap % with all units"),gradience_level,threshold_level);
        col_2_gr_and_thr = add_various_cols_of_over_percentage_above_n(blind_pass_table(remaining_idxs(:,2),"overlap % with all units"),gradience_level,threshold_level);
        table_of_nn_data = array2table([array_of_nn_data(:,end-1),col_1_gr_and_thr{:,1},col_2_gr_and_thr{:,1},array_of_nn_data(:,end)]);
