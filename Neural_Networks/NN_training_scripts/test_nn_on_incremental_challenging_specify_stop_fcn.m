function [accuracy,net] = test_nn_on_incremental_challenging_specify_stop_fcn(training_data,validation_data,layers,batch_size,early_stop_fcn)
...
options = trainingOptions("adam", ...
    ...
    Shuffle="every-epoch", ...
    OutputFcn=@(info) early_stop_fcn(info),...
