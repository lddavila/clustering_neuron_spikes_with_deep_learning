...
list_of_features_to_add = ["size","grades","mean waveform 1","mean waveform 2","mean waveform 3","mean waveform 4","histogram 1","histogram 2","histogram 3","histogram 4"];
list_of_features_to_add = ["histogram 1","histogram 2","histogram 3","histogram 4","mean waveform","size","grades"];
