function [] = switch_case_training_z_score_normalized_no_histograms(varargin)
...
dir_to_save_results_to = fullfile(parent_save_dir,"switch_case_z_score_normalized_no_histograms_extra_part");
...
for i=1:length(noise_levels)
    ...
    all_val_nn_data = [left_clust_data_val,right_clust_data_val,overlap_array_val,[zeros(number_of_comparisons_per_class,1);ones(number_of_comparisons_per_class,1)]];
    ...
    all_val_nn_data = [right_clust_data_val,left_clust_data_val,overlap_array_val,[zeros(number_of_comparisons_per_class,1);ones(number_of_comparisons_per_class,1)];all_val_nn_data];
